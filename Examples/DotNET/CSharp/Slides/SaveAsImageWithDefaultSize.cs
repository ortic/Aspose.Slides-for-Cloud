...
namespace Slides
{
    class SaveAsImageWithDefaultSize
    {
        public static void Run()
        {
            ...
            try
            {
                ...
                // Invoke Aspose.Slides Cloud SDK API to save slide as image with default size
                ...
                {                    
                    ...
                    Console.WriteLine("Save a PowerPoint Slide as Image with Default Size, Done!");
                    Console.ReadKey();
                }
            }
            catch (Exception ex)
