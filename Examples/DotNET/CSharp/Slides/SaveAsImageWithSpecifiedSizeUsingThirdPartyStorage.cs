...
namespace Slides
{
    class SaveAsImageWithSpecifiedSizeUsingThirdPartyStorage
    {
        public static void Run()
        {
            ...
            try
            {
                ...
                {                
                    ...
                    Console.WriteLine("Save a Particular Slide as Image with Specified Size Using Third Party Storage, Done!");
                    Console.ReadKey();
                }
            }
            catch (Exception ex)
