...
namespace Images
{
    class GetNumberOfImagesInPresentation
    {
        public static void Run()
        {
            ...
            try
            {
                ...
                // Invoke Aspose.Slides Cloud SDK API to get number of images in a presentation
                ...
                if (apiResponse != null)
                {
                    ...
                    Console.WriteLine("Get Number of Images in a Presentation, Done!");
                    Console.ReadKey();
                }
            }
            catch (Exception ex)
